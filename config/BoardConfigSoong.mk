...
SOONG_CONFIG_xdroidQcomVars_uses_qcom_old_display_hal := $(TARGET_USES_OLD_DISPLAY_HAL)
...
SOONG_CONFIG_xdroidQcomVars_qcom_display_intf_headers_namespace := vendor/qcom/opensource/commonsys-intf/display
else
...
SOONG_CONFIG_xdroidQcomVars_qcom_display_intf_headers_namespace := device/qcom/qssi/aidl/config
PRODUCT_SOONG_NAMESPACES += device/qcom/qssi/aidl/config
else
SOONG_CONFIG_xdroidQcomVars_qcom_display_intf_headers_namespace := $(QCOM_SOONG_NAMESPACE)/display
